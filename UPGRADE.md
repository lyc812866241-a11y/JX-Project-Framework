...
```powershell
python .\jxcheck-0.1.0.pyz --root C:\项目路径 upgrade --manifest .\project.manifest.json --dry-run
python .\jxcheck-0.1.0.pyz --root C:\项目路径 upgrade --manifest .\project.manifest.json --apply
python .\jxcheck-0.1.0.pyz --root C:\项目路径 restore --backup 返回的ID
python .\jxcheck-0.1.0.pyz --root C:\项目路径 restore --backup 返回的ID --apply
```
